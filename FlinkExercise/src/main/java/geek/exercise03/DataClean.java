...
//        DataStreamSource<String> allData = env.addSource(consumer);
        ...
        KafkaSource<String> kafkaSource = KafkaSource.<String>builder().setBootstrapServers("bigdata01:9092,bigdata02:9092,bigdata03:9092")
                .setTopics("data")
                .setGroupId("dataclean_consumer")
                .setStartingOffsets(OffsetsInitializer.earliest())
                .setProperty("enable.auto.commit","false").setValueOnlyDeserializer(new SimpleStringSchema()).build();
...
//        FlinkKafkaProducer011<String> kafkaSink = new FlinkKafkaProducer011<String>(etltopic,
//                new SimpleStringSchema(),
//                sinkProperties);
//
//
//        etlDataStream.addSink(kafkaSink);
        ...
        KafkaSink<String> kafkaSink = KafkaSink.<String>builder()
                ...
                .setRecordSerializer(KafkaRecordSerializationSchema.builder().setTopic("etldata")
